...
export class ReportCreateAndEditComponent extends BaseFormComponent {
  //#region Attributes
  ...
  @Output() protected courseAddRequested = new EventEmitter<Report>();

  /** Event emitter for when an existing course should be updated */
  @Output() protected courseUpdateRequested = new EventEmitter<Report>();
